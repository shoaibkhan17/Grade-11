...
void changeMaker(int change)
{
	...
	change = change - fiftyDollar * 5000;

	twentyDollar = change / 2000;
	change = change - twentyDollar * 2000;

	tenDollar = change / 1000;
	change = change - tenDollar * 1000;

	fiveDollar = change / 500;
	...
	//return fiftyDollar, twentyDollar, tenDollar, fiveDollar, toonie, loonie, quarter, dime, nickel, penny_2;
}
